...
{	
	...
	public function commande()
	{
		...
		foreach ($mes_articles as $article) 
		{
			$ma_commande = array( $_SESSION['id']['id_user'] ,$article->id_article, $article->prix_unitaire, $_SESSION['panier'][$article->id_article]);
			$this->_BDD->query('INSERT INTO panier (id_user, id_article, prix_unitaire, quantite) VALUES (?,?,?,?)', $ma_commande);
			echo "ok";
