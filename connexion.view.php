			...
			<div id="formulaire" class="col-sm-6 col-md-4 col-md-offset-4">
				...
				<div class="panel panel-default">
							...
							<fieldset>
								...
								<div class="row">
									<div class="col-sm-12 col-md-10  col-md-offset-1 ">
										...
										<div class="form-group">
											<input type="submit" name="form_connexion" class="btn btn-lg btn-primary btn-block" value="Connexion !">
										</div>
									</div>
								</div>
							</fieldset>
					...
					<div class="panel-footer ">
						Tu n'a pas encor de compte ! <a href="inscription.php" onClick=""> Inscrit toi ici </a>
					</div>
                </div>
			</div>
		</div>
